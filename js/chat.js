...
function generateAuthorResponse(input) {
  ...
  if (text.includes('похід') || text.includes('коли') || text.includes('наступн')) {
    ...
    return 'Усі 16 походів мають готові для завантаження GPX треки 1.1! Відкрийте будь-який похід у розділі «Подорожі» і тисніть кнопку «Завантажити GPX трек» для Garmin або OsmAnd.';
